 ...
 * Description:
 * Categories: forest/features, forest/testimonial
...
<!-- wp:heading -->
<h2 class="wp-block-heading">Forest is built for the new WordPress Site Editor</h2>
<!-- /wp:heading -->

<!-- wp:paragraph -->
<p>Did you know you can build a blazing-fast, fully-customisable website with the native WordPress editor now? Download the Forest block theme to start learning the new WordPress today!</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
...
<p class="has-x-small-font-size" style="font-style:normal;font-weight:500">— Alpine, Sandwich</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div>
