...
<p class="has-main-accent-color has-text-color has-small-font-size" style="font-style:normal;font-weight:500">Explore forest</p>
<!-- /wp:paragraph -->
...
<p class="has-text-align-left has-main-accent-color has-text-color" style="font-style:normal;font-weight:400">Effortlessly craft stunning, completely customisable websites using the latest WordPress Site Editor paired with the Forest Block theme. No coding expertise necessary.</p>
<!-- /wp:paragraph -->
...
<div class="wp-block-button has-custom-width wp-block-button__width-100"><a class="wp-block-button__link wp-element-button" href="https://www.google.com">Begin your journey today. →</a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
<!-- /wp:group --></div></div>
<!-- /wp:cover -->
