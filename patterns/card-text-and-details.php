 ...
 * Description:
 * Categories: forest/call-to-action, forest/hero, forest/features, forest/card
...
<h2 class="wp-block-heading has-base-color has-text-color">Use forest for free today and start building</h2>
<!-- /wp:heading -->

<!-- wp:paragraph {"textColor":"main-accent"} -->
<p class="has-main-accent-color has-text-color">Forest comes equipped with an expanding collection of design patterns that seamlessly click together. Simply drag, drop, mix, and match patterns to create stunning designs in just a few minutes. </p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
...
<p class="has-link-color has-small-font-size"><a href="https://wordpress.org">View on WordPress</a></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
...
<p class="has-main-accent-color has-text-color has-x-small-font-size">The WordPress Site Editor is a complete game-changer. Its blazing speed eliminates the need for a separate page builder.</p>
<!-- /wp:paragraph -->

<!-- wp:paragraph {"style":{"typography":{"fontStyle":"normal","fontWeight":"500"}},"fontSize":"x-small"} -->
<p class="has-x-small-font-size" style="font-style:normal;font-weight:500">— Casey West</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div>
