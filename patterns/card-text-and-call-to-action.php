 ...
 * Description:
 * Categories: forest/testimonial, forest/hero, forest/card, forest/call-to-action
...
<p class="has-primary-color has-text-color has-small-font-size" style="font-style:normal;font-weight:500">Explore forest</p>
<!-- /wp:paragraph -->

<!-- wp:heading -->
<h2 class="wp-block-heading">Design with just a few clicks</h2>
<!-- /wp:heading -->

<!-- wp:paragraph -->
<p>Forest is a block theme designed for the next generation of WordPress creators. Featuring stunning patterns and templates integrated directly, you can launch a website in record time.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
...
<p style="font-style:normal;font-weight:600">"Working with Forest has been a delightful experience from start to finish.”</p>
<!-- /wp:paragraph -->

<!-- wp:paragraph {"style":{"typography":{"fontStyle":"normal","fontWeight":"500"}},"textColor":"secondary","fontSize":"x-small"} -->
<p class="has-secondary-color has-text-color has-x-small-font-size" style="font-style:normal;font-weight:500">Rated 5/5 stars by 4206 happy reviewers</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div>
...
<h4 class="wp-block-heading has-base-color has-text-color">Download Theme</h4>
<!-- /wp:heading -->
...
<p class="has-base-color has-text-color">Effortlessly craft beautiful, fully customisable websites using the new WordPress Site Editor and the Forest Block theme. It's a task anyone can accomplish – no coding skills required!.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
...
<div class="wp-block-button has-custom-width wp-block-button__width-100"><a class="wp-block-button__link has-primary-color has-base-background-color has-text-color has-background wp-element-button" href="#">Download Right Now</a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons -->
...
<p class="has-text-align-center has-primary-accent-color has-text-color has-link-color has-x-small-font-size" style="text-decoration:underline">or view on WordPress</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div>
