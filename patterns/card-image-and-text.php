...
<figure class="wp-block-image size-full"><img src="<?php echo esc_url( get_template_directory_uri() ); ?>/patterns/images/inside-forest.webp" alt="" class="wp-image-43"/></figure>
<!-- /wp:image -->
...
<!-- wp:paragraph -->
<p>I enjoy using WordPress, but traditionally, designing in it has been challenging. Not anymore! Now, I can swiftly create full-page designs with beautiful patterns!</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
