...
<!-- wp:paragraph {"fontSize":"small"} -->
<p class="has-small-font-size">Your website deserves to look pixel-perfect on every device. forest ensures your entire design scales down gracefully automagically.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
...
<!-- wp:paragraph {"fontSize":"small"} -->
<p class="has-small-font-size">Creating unique designs has never been easier. forest's growing pattern library puts expertly designed patterns at your fingertips.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
