...
<ul class="wp-block-social-links has-icon-color is-style-logos-only"><!-- wp:social-link {"url":"https://twitter.com","service":"x"} /-->
...
<!-- wp:paragraph {"textColor":"base"} -->
<p class="has-base-color has-text-color">(01) 2345 9876</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
...
<!-- wp:paragraph {"textColor":"base"} -->
<p class="has-base-color has-text-color">1234 Forest Cir<br>Sydney NSW 2000</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div>
<!-- /wp:group -->
