...
<h4 class="wp-block-heading">Super simple customisation</h4>
<!-- /wp:heading -->

<!-- wp:paragraph -->
<p>Inject some splash of colours, select your header, and choose your favourite font — all achieved with just a few quick clicks. No coding skills are necessary.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:group -->
...
<!-- wp:paragraph -->
<p>Your website deserves to look pixel-perfect on every device. forest ensures your entire design scales down gracefully automagically.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:group -->
...
<!-- wp:paragraph -->
<p>We obsess over performance so you don’t have to. Forest is super lightweight and scores top marks on Google PageSpeed Insights.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div>
<!-- /wp:column --></div>
