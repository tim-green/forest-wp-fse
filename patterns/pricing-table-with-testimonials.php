...
<p class="has-text-align-center">Easily create beautiful and responsive pricing tables with Forest patterns. Connect your eCommerce solution and start making bank.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
...
<p class="has-small-font-size">Now that I’ve seen how powerful the Site Editor can be, I can't live without it. Forest made it super easy to get started with the “new” WordPress.</p>
<!-- /wp:paragraph -->
...
<!-- wp:group {"style":{"spacing":{"blockGap":"var:preset|spacing|small"}},"layout":{"type":"flex","orientation":"vertical"}} -->
<div class="wp-block-group"><!-- wp:paragraph {"fontSize":"small"} -->
<p class="has-small-font-size">I finally feel like I can ditch my costly page builder plugin. Now, I can quickly build out page sections or full page designs with Forest patterns. </p>
<!-- /wp:paragraph -->
